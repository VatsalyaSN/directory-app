								...
								<div key={i}>
									{
										...
										<div className="new-folder" >
											...
											<input type="text" className="folder-name" ref={folderNameElm => this.folderNameElm = folderNameElm} onKeyPress={this.props.handleUpdateFolderName.bind(this,folder,i)} autoFocus="true" onBlur={()=>this.props.handleUpdateFolderName(folder,i,this.folderNameElm)}/>
										</div>
										:
